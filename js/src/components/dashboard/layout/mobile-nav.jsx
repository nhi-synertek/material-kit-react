...
export function MobileNav({ open, onClose }) {
    ...
    return (<Drawer PaperProps={{
      ...
      <Stack spacing={2} sx={{ p: '12px' }}>
        ...
        <Button component="a" endIcon={<ArrowSquareUpRightIcon fontSize="var(--icon-fontSize-md)"/>} fullWidth href="https://material-kit-pro-react.devias.io/" sx={{ mt: 2 }} target="_blank" variant="contained">
          Pro version
        </Button>
      </Stack>
    </Drawer>);
...
function renderNavItems({ items = [], pathname }) {
    ...
    return (<Stack component="ul" spacing={1} sx={{ listStyle: 'none', m: 0, p: 0 }}>
      {children}
    </Stack>);
}
